      ...
      do
        {
          ...
          if (!strcmp (cptr, "exit"))
          ...
          else
            {
              ...
              for (arg = strtok_r (cptr, " ", &saveptr); arg != NULL && (unsigned)i < sizeof(argv) - 1;
...
/* Remove leading and trailing spaces. Repeat for each command delimited. */
